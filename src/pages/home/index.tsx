...
`}
                ...
                <p className="mt-7 mx-auto w-[400px] sm:w-[900px] text-slate-300 text-center bg-[rgba(255,255,255,0.03)] border border-slate-700 rounded-3xl shadow-xl p-4 md:p-6 backdrop-blur-md text-sm leading-relaxed">
                    Every action — creating a game, joining one, and making moves — is on-chain and requires <br /> a wallet-approved transaction. Play safely and transparently! <br />The contract is verified and you can access it at the address below: <br />
                    <a
                        href="#"
                        className="underline break-all text-blue-400 hover:text-blue-300 transition"
                        onClick={() => {
                            handleContractLink();
                        }}
                    >
